...
/*   Updated: 2016/09/09 10:11:00 by sbenning         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "sh.h"

void			dump_root(t_tree *root, int i, t_dic_entry *bin)				//Print a colored representation of the execution tree //BUG-03: Norme
{
	t_lxem		*list;
...
void			dump_root_log(t_tree *root, int i, t_dic_entry *bin, int fd)	//Log a representation of the execution tree //BUG-03: Norme
{
	t_lxem		*list;
