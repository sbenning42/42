...
/*   Updated: 2015/11/29 23:48:18 by sbenning         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		lexer_tokenadd(t_list **alst, t_lex_tk *content, t_lex_rule rule);
void		lexer_tokenchr(char *s, t_lex_tk *pattern, size_t size, t_lex_tk *token);
void		lexer_constchr(char *s, t_lex_tk *token);

t_list		*ft_lexer(t_lex_rule rule, t_lex_tk *pattern, size_t size, char *s);
